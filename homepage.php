            ...
            <div class="space-y-4">
                ...
                <div class="prose prose-lg text-gray-600">
                    <p class="text-base md:text-lg">
                        ভারতে আধুনিক শিক্ষা বিস্তারের সাথে ইস্ট ইন্ডিয়া কোম্পানি ও ব্রিটিশ শাসন নিবিড়ভাবে সম্পর্কিত। ইস্ট ইন্ডিয়া কোম্পানির শাসন প্রাধান্য লভে ছুটা পাচার ও ব্যবসায়া তত্বও তারা ভারতীয়দের জন্য ১৭১৬ সালে কলকাতা মাদ্রাসা, ১৭৯১ সালে বারাণসীতে সংস্কৃত কলেজ এবং ১৮০০ সালে ইস্ট ইন্ডিয়া কোম্পানির কর্মচারীদের জন্য 'ফোর্ট উইলিয়াম কলেজ' প্রতিষ্ঠা করে। কিন্তু 'চার্টার অ্যাক্ট-১৮১৩' এর মাধ্যমে ব্রিটিশ সরকার কর্তৃক ইস্ট ইন্ডিয়া কোম্পানিকে ভারতীয়দের শিক্ষার প্রতি মনোযোগী হওয়ার নির্দেশ দেওয়া হ...
                    </p>
                    <div class="mt-6">
                        <a href="#" class="inline-flex items-center px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-300">
                            বিস্তারিত পড়ুন
